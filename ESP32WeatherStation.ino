...
//
// Keys stored outside of source file
//
...
const char* mqttUser = MQTTUSER; // #define'd in PrivateKeys.h
const char* mqttPass = MQTTPASS; // #define'd in PrivateKeys.h
char writeAPIKey[] = MQTTAPIKEY; // #define'd in PrivateKeys.h
long channelID = MQTTCHANNELID;  // #define'd in PrivateKeys.h
...
void setup() {
  ...
  //
  // WiFi
  WiFi.begin(WIFISSID, PASSWORD);  // #define'd in PrivateKeys.h
  Serial.println();
